...
- add `restore` command to revert artifacts to original state ([19589c5](https://github.com/tinesoft/spec-kit-token-budget/commit/19589c5))
- extend support to `constitution.md`  in `compact`, `restore` and `usage` commands ([0e4ea65](https://github.com/tinesoft/spec-kit-token-budget/commit/0e4ea65))
- inject backup guard directive to prevent agents from reading `.full.md` files ([5ae5ec5](https://github.com/tinesoft/spec-kit-token-budget/commit/5ae5ec5))
- integrate `caveman-code` as opt-in compression tier ([8b506f8](https://github.com/tinesoft/spec-kit-token-budget/commit/8b506f8))
